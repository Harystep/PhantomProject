//
//  AGHomeSearchPostTableViewCell.m
//  Arcadegame
//
...
@interface AGHomeSearchPostTableViewCell ()
...
@implementation AGHomeSearchPostTableViewCell
...
- (void)layoutSubviews {
    ...
    NSArray *mediaArray = @[@"https://img.ssjww100.com/1675936289203.jpg"];//[self.mData.media componentsSeparatedByString:@";"];
    ...
    self.mInfoLabel.text = [NSString stringSafeChecking:@"阿斯卡电话卡金黄色的哈卡"];
    ...
    self.mMsgNumLabel.text = [NSString stringSafeChecking:[HelpTools checkCircleInfo:@"1123"]];
    self.mLikeNumLabel.text = [NSString stringSafeChecking:[HelpTools checkCircleInfo:@"1123"]];
    ...
    self.mMarkLabel.text = [NSString stringWithFormat:@"#%@", [NSString stringSafeChecking:@"asdhaksdk"]];
}
